...
class test_inherit_basemodel(unittest.TestCase):
    ...
    def test_instance(self):
        """scans if user is an instance of BaseModel"""
        user = Amenity()
...
class TestAmenity(unittest.TestCase):
    """Test run the Amenity class"""

    def test_is_subclass(self):
        """Test that the Amenity is a subclass of BaseModel"""
        amenity = Amenity()
    ...
    def test_name_attr(self):
        """Test that the Amenity has attribute name, and it's as an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """Test run to_dict method generates a dictionary with proper attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """Test run that values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """test run that the str method has the correct output"""
        amenity = Amenity()
