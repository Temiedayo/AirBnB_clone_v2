...
class Test_docstrings(unittest.TestCase):
    ...
    def setup_class(self):
        ...
        Return all members of an object in a list of (name, value)
...
class TestBaseModel(unittest.TestCase):
    ...
    @classmethod
    def teardown(cls):
        """at the end of test this will tear it down"""
        del cls.base
    ...
    def test_method_BaseModel(self):
        """scanning if Basemodel have methods"""
        self.assertTrue(hasattr(BaseModel, "__init__"))
        self.assertTrue(hasattr(BaseModel, "save"))
        self.assertTrue(hasattr(BaseModel, "to_dict"))

    def test_init_BaseModel(self):
        """test run if the base is an type BaseModel"""
        self.assertTrue(isinstance(self.base, BaseModel))

    def test_save_BaesModel(self):
        """testrun  if the save works"""
        self.base.save()
        self.assertNotEqual(self.base.created_at, self.base.updated_at)

    def test_to_dict_BaseModel(self):
        """test run if dictionary works"""
